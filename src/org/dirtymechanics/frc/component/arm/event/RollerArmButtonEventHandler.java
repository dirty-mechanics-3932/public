...
public class RollerArmButtonEventHandler implements ButtonEventHandler {
    private GameController controller;
    private Roller roller;
    
    public RollerArmButtonEventHandler(GameController operatorController, Roller roller) {
