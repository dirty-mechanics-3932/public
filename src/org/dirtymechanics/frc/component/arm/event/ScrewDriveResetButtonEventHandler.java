...
public class ScrewDriveResetButtonEventHandler implements ButtonEventHandler {
    private GameController controller;
    private ScrewDrive screwDrive;
    
    public ScrewDriveResetButtonEventHandler(GameController operatorController, ScrewDrive screwDrive) {
