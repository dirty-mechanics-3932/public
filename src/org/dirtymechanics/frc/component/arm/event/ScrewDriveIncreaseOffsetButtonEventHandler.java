...
public class ScrewDriveIncreaseOffsetButtonEventHandler implements ButtonEventHandler {
    private GameController controller;
    private ScrewDrive screwDrive;
    
    public ScrewDriveIncreaseOffsetButtonEventHandler(GameController operatorController, ScrewDrive screwDrive) {
